 ...
 * node may change.
 */
_AVL_H bool avl_update(avl_tree_t *, void *);
_AVL_H bool avl_update_lt(avl_tree_t *, void *);
_AVL_H bool avl_update_gt(avl_tree_t *, void *);
 ...
 */
_AVL_H unsigned long avl_numnodes(avl_tree_t *tree);

/*
 * Return B_TRUE if there are zero nodes in the tree, B_FALSE otherwise.
 */
_AVL_H bool avl_is_empty(avl_tree_t *tree);
